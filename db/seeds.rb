...
mug_and_mingle = Facility.create!(address: "California Rd, New Malden KT3 3RL",
  business_owner: false,
  rating: 5.0,
  toilet: true,
  sanitary_products: false,
...
wake_and_brew = Facility.create!(address: "1 Sherfield Cl, New Malden KT3 3TD",
  ...
  education: false,
  name: "Wake & Brew",
  opening_hours: "Open 06:00 - 15:00",
  user: ivy,
  image: "https://i.guim.co.uk/img/media/37fc1655dae9fe6f9f415fbde098fd0b10c51d60/0_0_3500_2333/master/3500.jpg?width=980&dpr=2&s=none&crop=none",
)

new_malden_reading_room = Facility.create!(address: "Windsor Ave, New Malden KT3 5HA",
  business_owner: false,
  rating: 5,
  toilet: true,
  sanitary_products: false,
...
the_learning_loft = Facility.create!(address: "Galsworthy Rd, Kingston upon Thames KT2 7QB",
  ...
  opening_hours: "Open 09:00 - 17:00",
  user: ivy,
  image: "https://haworth-tompkins-assets.imgix.net/uploads/0408_N16_htwebcrp.jpg?auto=compress%2Cformat&fit=fit&h=1000&interlace=line&ixlib=php-3.1.0&q=85&resizeFilter=triangle&v=1515518278&w=1400&s=94b5dce1880e76af2f6eb1a6adfc7935",
)
